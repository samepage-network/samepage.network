...
const TermsOfUsePage: React.FC = () => (
  <div className="w-full max-w-2xl">
    ...
    <P>
      The SamePage website located at https://samepage.network was founded by
      SamePage Network, Inc. Certain features of the Site may be subject to
    ...
    <Subtitle className="mt-6">Access to the Site</Subtitle>
    <P>
      Subject to these Terms. Company grants you a non-transferable,
      non-exclusive, revocable, limited license to access the Site for your use.
    </P>
    <Subtitle className="mt-6">Certain Restrictions.</Subtitle>
    <P>
    ...
    <Subtitle className="mt-6">No Support or Maintenance</Subtitle>
    <P>
      You agree that Company will have no obligation to provide you with any
      support in connection with the Site.
    </P>
    <Subtitle className="mt-6">Third-Party Links</Subtitle>
    <P>
    ...
    <Subtitle className="mt-6">Other Users</Subtitle>
    <P>
    ...
    <P>
      Like any other website, the SamePage website use 'cookies'. These cookies
    ...
    <Subtitle className="mt-6">Disclaimers</Subtitle>
    <P>
    ...
    <Subtitle className="mt-6">Limitation on Liability</Subtitle>
    <P>
    ...
    <Subtitle className="mt-6">Term and Termination</Subtitle>
    <P>
    ...
    <Subtitle className="mt-6">General</Subtitle>
    <P>
    ...
    <Subtitle className="mt-6"> Arbitration Rules.</Subtitle>
    <P>
    ...
    <Subtitle className="mt-6"> Time Limits.</Subtitle>
    <P>
    ...
    <Subtitle className="mt-6"> Authority of Arbitrator.</Subtitle>
    <P>
    ...
    <Subtitle className="mt-6"> Waiver of Jury Trial.</Subtitle>
    <P>
    ...
    <Subtitle className="mt-6"> Confidentiality.</Subtitle>
    <P>
    ...
    <Subtitle className="mt-6"> Severability.</Subtitle>
    <P>
    ...
    <Subtitle className="mt-6"> Right to Waive.</Subtitle>
    <P>
    ...
    <Subtitle className="mt-6"> Claims Not Subject to Arbitration.</Subtitle>
    <P>
    ...
    <Subtitle className="mt-6"> Electronic Communications.</Subtitle>
    <P>
    ...
    <Subtitle className="mt-6"> Entire Terms.</Subtitle>
    <P>
    ...
    <Subtitle className="mt-6"> Your Privacy.</Subtitle>
    <P>
      Please read our{" "}
      <ExternalLink href={"/privacy-policy"}>Privacy Policy</ExternalLink>.
    </P>
    <Subtitle className="mt-6"> Contact Information</Subtitle>
    <P>
      Please read our{" "}
